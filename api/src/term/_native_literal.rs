...
impl Term for f64 {
    ...
    fn datatype(&self) -> Option<IriRef<MownStr>> {
        Some(IriRef::new_unchecked(MownStr::from_slice(&XSD_DOUBLE)))
    }
...
impl Term for i32 {
    ...
    fn datatype(&self) -> Option<IriRef<MownStr>> {
        Some(IriRef::new_unchecked(MownStr::from_slice(&XSD_INTEGER)))
    }
    fn language_tag(&self) -> Option<LanguageTag<MownStr>> {
        None
    }
...
impl Term for str {
    ...
    fn datatype(&self) -> Option<IriRef<MownStr>> {
        Some(IriRef::new_unchecked(MownStr::from_slice(&XSD_STRING)))
    }
    fn language_tag(&self) -> Option<LanguageTag<MownStr>> {
        None
    }
...
impl Term for bool {
    ...
    fn datatype(&self) -> Option<IriRef<MownStr>> {
        Some(IriRef::new_unchecked(MownStr::from_slice(&XSD_BOOLEAN)))
    }
    fn language_tag(&self) -> Option<LanguageTag<MownStr>> {
        None
    }
